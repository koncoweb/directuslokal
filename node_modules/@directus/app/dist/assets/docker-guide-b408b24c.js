...
docker-compose up -d
`)]),s("p",null,"The images will be pulled and the containers recreated. Migrations will happen automatically so once the containers have started you will be on the latest version (or the version you specified)."),s("h2",{id:"supported-databases",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#supported-databases"},"#"),e(" Supported Databases")]),s("p",null,"The Directus Docker Image contains all optional dependencies supported in the API. This means the Docker image can be used with most of the supported databases and storage adapters without having to create a custom image."),s("p",null,"To run Directus, you currently need one of the following databases:"),s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"Database"),s("th",null,"Version")])]),s("tbody",null,[s("tr",null,[s("td",null,"PostgreSQL"),s("td",null,"10+")]),s("tr",null,[s("td",null,[e("MySQL "),s("sup",null,"[1]")]),s("td",null,"5.7.8+ / 8+")]),s("tr",null,[s("td",null,"SQLite"),s("td",null,"3+")]),s("tr",null,[s("td",null,"MS SQL Server"),s("td",null,"13+")]),s("tr",null,[s("td",null,[e("MariaDB "),s("sup",null,"[2]")]),s("td",null,"10.2.7+")]),s("tr",null,[s("td",null,[e("CockroachDB "),s("sup",null,"[2]")]),s("td",null,"21.1.13+")]),s("tr",null,[s("td",null,[e("OracleDB"),s("sup",null,"[2]"),e(),s("sup",null,"[3]")]),s("td",null,"19+")])])]),s("p",null,[s("sup",null,"[1]"),e(" MySQL 8+ requires "),s("a",{href:"https://dev.mysql.com/doc/refman/8.0/en/upgrading-from-previous-series.html#upgrade-caching-sha2-password-compatible-connectors",target:"_blank",rel:"noopener noreferrer"},"mysql_native_password"),e(" to be enabled"),s("br"),s("sup",null,"[2]"),e(" Older versions may work, but aren’t officially supported. Use at your own risk. "),s("br"),s("sup",null,"[3]"),e(" Make sure to install "),s("code",null,"node-oracledb"),e(" and it’s system dependencies when using OracleDB")]),s("div",{class:"warning hint"},[s("div",{class:"hint-title"},"OracleDB"),s("p",null,[e("OracleDB’s Node client ("),s("code",null,"node-oracledb"),e(") requires a couple more native dependencies, and specific configurations in order to run. The official Directus Docker image does not include these dependencies. See "),s("a",{href:"https://blogs.oracle.com/opal/dockerfiles-for-node-oracledb-are-easy-and-simple",target:"_blank",rel:"noopener noreferrer"},"https://blogs.oracle.com/opal/dockerfiles-for-node-oracledb-are-easy-and-simple"),e(" for more information on what to include for OracleDB.")])])],-1),m="Docker Guide",g=!1,j="How to host Directus on Docker.",b="3 min read",f={__name:"docker-guide",setup(u,{expose:n}){const a={title:"Docker Guide",modularExtension:!1,description:"How to host Directus on Docker.",readTime:"3 min read"};return n({frontmatter:a}),(d,p)=>{const l=t("docs-wrapper");return r(),o(l,{frontmatter:a},{default:c(()=>[i]),_:1})}}};export{f as default,j as description,g as modularExtension,b as readTime,m as title};

...
`)]),e("h1",{id:"saml-examples",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#saml-examples"},"#"),n(" SAML Examples")]),e("h2",{id:"aws-sso",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#aws-sso"},"#"),n(" AWS SSO")]),e("pre",null,[e("code",null,`AUTH_SSO_DRIVER=saml
...
`)]),e("p",null,"::: advice Notice"),e("ul",null,[e("li",null,[e("p",null,[n("AWS SSO Docs are not that verbose. Users have found you don’t can supply "),e("code",null,"sp_metadata"),n(" ENV var as EMPTY.")])]),e("li",null,[e("p",null,[n("Users have found that replacing "),e("code",null,'<md:SingleSignOnService Binding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect" Location="https://your-soo-portal-url"/>'),n(" in the IAM Identity Center SAML metadata file with your AWS Portal URL is a fix for getting the ‘Login With SSO’ button on Directus to work, rather the default redirect from AWS.")])]),e("li",null,[e("p",null,[n("Directus expects "),e("code",null,'<?xml version="1.0" encoding="UTF-8"?>'),n(" to be removed from the start of the XML.")])])]),e("p",null,":::"),e("p",null,[e("strong",null,"Mapping:")]),e("p",null,"Maps the email address into Directus as external_identifier:"),e("pre",null,[e("code",null,`| User attribute in the application | Maps to this string value or user attribute in IAM Identity Center | type |
| --- | ----------- | --- |
| Subject | \${user:email} | emailAddress |
| email | \${user:email} | unspecified |
`)]),e("p",null,[e("strong",null,"Config:")]),e("p",null,[n("Relay state - "),e("code",null,"admin/login"),n(" Application ACS URL - "),e("code",null,"https://you-directus-instance/auth/login/awssso/acs")])],-1),A="SSO Examples",E=!1,h="A collection of example Directus configurations for integrating with various OAuth 2.0, OpenID and SAML platforms.",I="2 min read",p={__name:"sso-examples",setup(T,{expose:a}){const t={title:"SSO Examples",modularExtension:!1,description:"A collection of example Directus configurations for integrating with various OAuth 2.0, OpenID and SAML platforms.",readTime:"2 min read"};return a({frontmatter:t}),(c,d)=>{const o=i("docs-wrapper");return l(),_(o,{frontmatter:t},{default:r(()=>[s]),_:1})}}};export{p as default,h as description,E as modularExtension,I as readTime,A as title};

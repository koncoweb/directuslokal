...
`),t("span",{class:"hljs-punctuation"},"}"),s(`
`)])],-1),I=t("p",null,[s("This will create a new record in the related collection, and save its primary key in the "),t("code",null,"featured_article"),s(" field for this item. To update an existing item, simply provide the primary key with the updates, and Directus will treat it as an update instead of a creation:")],-1),k=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),s(`
	`),t("span",{class:"hljs-attr"},'"featured_article"'),t("span",{class:"hljs-punctuation"},":"),s(),t("span",{class:"hljs-punctuation"},"{"),s(`
...
`)],-1),X=t("h5",{id:"graphql",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#graphql"},"#"),s(" GraphQL")],-1),J=t("p",null,"In GraphQL, you can use nested fragments on the Union Type to select the fields:",-1),Z=t("pre",null,[t("code",{class:"language-graphql"},[t("span",{class:"hljs-keyword"},"query"),s(),t("span",{class:"hljs-punctuation"},"{"),s(`
	pages `),t("span",{class:"hljs-punctuation"},"{"),s(`
		sections `),t("span",{class:"hljs-punctuation"},"{"),s(`
			item `),t("span",{class:"hljs-punctuation"},"{"),s(`
				`),t("span",{class:"hljs-punctuation"},"..."),s(),t("span",{class:"hljs-keyword"},"on"),s(" headings "),t("span",{class:"hljs-punctuation"},"{"),s(`
					id
					title
				`),t("span",{class:"hljs-punctuation"},"}"),s(`

				`),t("span",{class:"hljs-punctuation"},"..."),s(),t("span",{class:"hljs-keyword"},"on"),s(" paragraphs "),t("span",{class:"hljs-punctuation"},"{"),s(`
					body
					background_color
				`),t("span",{class:"hljs-punctuation"},"}"),s(`
			`),t("span",{class:"hljs-punctuation"},"}"),s(`
